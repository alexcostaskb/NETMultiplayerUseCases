...
namespace Unity.Netcode.Samples.MultiplayerUseCases.Common
{
    ...
    {
        [SerializeField] private SpriteRenderer m_BackgroundSprite;
        [SerializeField] private TMP_Text m_MessageLabel;
        [SerializeField] private Vector2 m_Padding;
        [SerializeField] private int m_MaxCharactersPerLine = 20;
        [SerializeField] private string m_DefaultMessage;
