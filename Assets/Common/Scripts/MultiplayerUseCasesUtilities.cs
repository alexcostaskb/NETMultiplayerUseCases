...
namespace Unity.Netcode.Samples.MultiplayerUseCases.Common
{
    ...
    {
        private static readonly string[] s_Usernames = new string[]
        {
            "MaryDaBest",
            "BobTheBell",
            "FranklyVal",
        ...
        /// <summary>
        /// Filters some 'bad words' from a string. 
        /// In a production environment, consider using an external service for complex tasks like this.
        /// Players can be quite imaginative creating workarounds for those types of filters, 
        /// using a library or service abstracting that complexity away is usually more strategic.
        /// </summary>
